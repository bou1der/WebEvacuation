...
<head>
    ...
    <link rel="stylesheet" href="/styles/ourStyles.css">
...
<?php require_once("actions/helper.php");?>
    ...
    <article>
        <div class="block1">
            <div class="backimg">
                <img class="img1" src="/resource/background/image 1.png" alt="">
                <img class="img2" src="/resource/background/Rectangle 3.png" alt="">
            </div>
            <div class="block1content">
                <h1>Эвакуируем авто по Москве и Московской области</h1>
            </div>
        </div>
    </article>
    <!-- header -->
    <article>
        <header class="header">
            <div class="contentHeader">
                <div>
                    <img src="/resource/item/Location.svg" alt="">
                    <p>Базируемся по всей Москве и МО</p>
                </div>
                <div>
                    <img src="/resource/item/Time Circle.svg" alt="">
                    <p>Круглосуточная поддержка</p>
                </div>
                <div>
                    <img src="/resource/item/Calling.svg" alt="">
                    <p>Телефон для связи: <a href="tel: +79113031911">+7 911 303-19-11</a></p>
                </div>
                <!-- <div>
                    <button class="buttOrder">Заказать обратный звонок</button>
                </div> -->
            </div>
        </header>
    </article>
        ...
        <div class="block2">
            ...
            <div class="block2content">
                ...
                <aside class="imgcontainer">
                    <img src="/resource/background/image 2.png" alt="">
                </aside>
            </div>
            </div>
        </div>
    ...
    <!-- block3 -->
    <article>
        <div class="block3 marg">            
            <div class="block3content">
                <aside class="imgcontainer">
                    <img src="/resource/background/image 3.png" alt="">
                </aside>
                <aside class="Info">
                        <p>Преимущества нашей компании:</p>
                        <ul>
                            <li>Круглосуточно работающая диспетчерская;</li>
                            <li>Подача эвакуатора в любой район Москвы и Московской области занимает от 15 минут;</li>
                            <li>Стоимость заказа от 1500 рублей;</li>
                            <li>Качественная и безопасная доставка автомобиля.</li>
                        </ul>
                </aside>
            </div>
        </div>
    ...
    <!-- block4 -->
    <article>
        <div class="blockTemp" id="contact">
    ...
    <article>
        <div class="block5">
            ...
            <div>
                <img src="/resource/item/evo1.png" alt="">
                <img src="/resource/item/evo2.png" alt="">
                <img src="/resource/item/evo3.png" alt="">
                <img src="/resource/item/evo4.png" alt="">
                <img src="/resource/item/evo5.png" alt="">
                <img src="/resource/item/evo6.png" alt="">
                <img src="/resource/item/evo7.png" alt="">
            </div>
        </div>
    </article>
    ...
    <footer>
        <div class="footer">
            <div>
                <b>Информация, представленная на сайте, не является публичной офертой</b>
            </div>

            <!-- <div>
                <h5>© 2017–2023 ООО «СТО»</h5>
                <ul>
                    <li>Оферта</li>
